...
- On the terminal run this command git clone https://github.com/App-Developer8866/LeaderBoard_gitFlow.git
...
Feel free to check the [issues page](https://github.com/App-Developer8866/LeaderBoard_gitFlow/issues).
